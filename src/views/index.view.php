...
<?php include __DIR__ . '/partials/page-header.php'; ?>
    ...
    <section class="content-section"> 
        <div class="small-container">
            ...
            <p>Laconia runs on PHP 7.2 and MySQL. It uses <a href="https://getcomposer.org/">Composer</a> to autoload classes and configuration and utility files, as well as future tests through <a href="https://phpunit.de/">PHPUnit</a>. Node is used to compile Sass to CSS via npm scripts.</p>
